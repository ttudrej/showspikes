...
df = pd.read_csv('D:/DataFileForSeismometer/DATALOG1.csv', names=col_names, low_memory=False, encoding='utf-8', sep='\s+')

# ****     the sep='\s+' I got from an internet reasearch and it seem to take care of the format issues    *******
